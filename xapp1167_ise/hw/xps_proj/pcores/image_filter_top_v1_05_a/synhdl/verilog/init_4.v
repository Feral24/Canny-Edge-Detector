...
begin : ap_ret_ap_return_1_preg
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_29)) begin
            ap_return_1_preg <= tmp_57_fu_33_p1;
        end
    end
end
...
always @ (ap_CS_fsm or ap_sig_bdd_29 or tmp_57_fu_33_p1 or ap_return_1_preg)
begin
    if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_29)) begin
        ap_return_1 = tmp_57_fu_33_p1;
    end else begin
...
assign tmp_57_fu_33_p1 = p_cols[11:0];
