...
begin : ap_ret_ap_return_2_preg
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_31)) begin
            ap_return_2_preg <= tmp_55_fu_33_p1;
        end
    end
end
...
begin : ap_ret_ap_return_3_preg
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_31)) begin
            ap_return_3_preg <= tmp_55_fu_33_p1;
        end
    end
end
...
always @ (ap_CS_fsm or ap_sig_bdd_31 or tmp_55_fu_33_p1 or ap_return_2_preg)
begin
    if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_31)) begin
        ap_return_2 = tmp_55_fu_33_p1;
    end else begin
...
always @ (ap_CS_fsm or ap_sig_bdd_31 or tmp_55_fu_33_p1 or ap_return_3_preg)
begin
    if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_31)) begin
        ap_return_3 = tmp_55_fu_33_p1;
    end else begin
...
assign tmp_55_fu_33_p1 = p_cols[11:0];
